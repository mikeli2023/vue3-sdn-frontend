  ...
  <section id="container-main">
    <div class="banner">
      <div class="content lang-max flex-row">
        <div class="text">
          <h1 class="font-48 font-gilroy-bold">{{$t('product.cloud.title')}}</h1>
          <p class="font-24" v-html="$t('product.cloud.describe')"></p>
          <div class="learn-more font-30" @click="getStarted">{{$t('product.cloud.btn')}}</div>
        </div>
      </div>
    </div>
...
export default defineComponent({
  ...
  setup () {
    ...
    const modelData = ref([
      {
        title: t('product.cloud.list.title-1'),
        desc: t('product.cloud.list.describe-1')
      },
      {
        title: t('product.cloud.list.title-2'),
        desc: t('product.cloud.list.describe-2')
      },
      {
        title: t('product.cloud.list.title-3'),
        desc: t('product.cloud.list.describe-3')
      }
    ])

    function getStarted () {
      // if (emailAddress.value) router.push({ name: 'creatVM' })
