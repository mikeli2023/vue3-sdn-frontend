  ...
  css: {
    loaderOptions: {
      less: {
        ...
        modifyVars: {
          'white-color': '#fff',
          'black-color': 'rgba(14, 15, 23, 1)',
          'black-color-opacity1': 'rgba(14, 15, 23, 0.24)',
          'black-color-opacity2': 'rgba(14, 15, 23, 0.04)',
          'theme-color': 'rgba(40, 71, 157, 1)',
          'theme-color-opacity1': 'rgba(40, 71, 157, .8)'
        },
      }
    }
  },
